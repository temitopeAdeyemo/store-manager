...
router.delete('/delete', deleteCategory_validator_1.default, auth_1.default, controllers_1.deleteCategory.delete);
router.patch('/update', updateCategory_validator_1.default, auth_1.default, controllers_1.updateCategory.update);
